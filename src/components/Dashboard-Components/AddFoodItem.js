...
function AddFoodItem() {
    ...
    const addFoodItemDetails = async () => {
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="form-group">
                        ...
                        <textarea id="form_message" name="Description" className="form-control" rows={4} required="required" data-error="Please, leave us a message." defaultValue={""} onChange={(e) => onValueChange(e)} />
                      </div>
                    </div>
                    <div className="col-md-12">
                      <button type="submit" className="btn btn-primary pt-2 btn-block" style={{color: 'white'}} onClick={() => addFoodItemDetails()}>Add Item</button>
                    </div>
                  </div>
                </div>
              </div>
