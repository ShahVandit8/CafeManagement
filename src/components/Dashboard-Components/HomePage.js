...
import { getTotalNoCategory, getFoodItemCount, getTableCount, getStaffCount } from '../../services/api'
    ...
    <div>
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          {/* {totalCategory ? (
            <CardInfo title="Total Category"
              icon="shopping-bag"
              color="dark"
              value={totalCategory} />
          ) : (
            <div className="my-auto d-block"></div>
          )} */}
