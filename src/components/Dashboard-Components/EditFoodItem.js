...
function EditFoodItem() {
    ...
    const editFoodItemDetails = async () => {
              ...
              <div id="contact-form" role="form">
                <div className="controls">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12">
                      <button type="submit" className="btn btn-primary pt-2 btn-block" style={{color: 'white'}} onClick={() => editFoodItemDetails()}>Edit Item</button>
                    </div>
                  </div>
                </div>
              </div>
