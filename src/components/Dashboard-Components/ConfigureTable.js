...
function ConfigureTable() {
    ...
    const downloadQRCode = () => {
        console.log(table)
        saveAs(response, `${table.Table_No}.png`)
    }
                      ...
                      <div className="row">
                        <div className="col-md-12">
                          <div className="form-group">
                            ...
                            <input id="form_name" type="text" name="Table_No" className="form-control" placeholder="Enter only Number" required data-error="Table Name is required." onChange={(e) => onValueChange(e)} />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-md-12">
                          <div className="form-group">
                            ...
                            <input id="form_name" type="text" name="Seating_Capacity" placeholder="Enter only Number" className="form-control" required data-error="Seating Capacity is required." onChange={(e) => onValueChange(e)} />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-md-12">
                          <button type="submit" className="btn btn-success mt-3 btn-block" style={{color: 'white'}} onClick={() => getQrCode()}>Generate QR Code</button>
                        ...
                        <div className="col-md-12 mt-5">
                          <button type="submit" className="btn btn-primary pt-2 btn-block" style={{color: 'white'}} onClick={() => configureTable()}>Configure Table</button>
                        </div>
                    </div>
                  </div>
                </div>
