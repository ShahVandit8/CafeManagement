                      ...
                      <div className="row">
                        <div className="col-md-12">
                          <div className="form-group">
                            ...
                            <input id="form_name" type="text" name="Category" className="form-control" required data-error="Firstname is required." onChange={(e) => onValueChange(e)} />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-md-12">
                          <button type="submit" className="btn btn-primary pt-2 btn-block" style={{color: 'white'}} onClick={() => addFoodCategory()}>Add Category</button>
                        </div>
                      </div>
                    </div>
                  </div>
